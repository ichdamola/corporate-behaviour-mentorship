...
**Why this matters:** The two peers who oversell thin work are training your manager to discount their updates. The one who undersells real work is training your manager to forget them. You want to be the third thing: calibrated.

## 2. Name your goal

Your goal for these 60 seconds is **not** "report everything I did." It's "leave one impression: *this person moves important things forward and I can see it.*"

That means you're selecting, not summarizing. Most weeks have one thing worth being remembered for. Lead with that. The rest is supporting cast.

> 💬 **How to say it:** *(internally)* "If they remember one sentence from me, what should it be?"

## 3. Separate fact from feeling

You might *feel* like you didn't do much ("just fixed a bug, helped someone, made progress"). Strip the feeling. State the facts:

- The bug was blocking checkout for 4% of users → you fixed it.
- A teammate was stuck for two days → you unblocked them in an hour.
- The project moved from design to first working endpoint.

Those are not "just" anything. The underseller's whole problem is that they apply a discount to their own facts before anyone else gets to.

> 💬 **How to say it:** *(internally)* "What actually happened, in business terms, with the adjectives removed?"
...
> 💬 **How to say it (in the channel, before the meeting):** "Quick async update ahead of sync: checkout bug (4% of users) is fixed and deployed; payments project hit first working endpoint; helped Sam unblock the migration."

## 5. Headline first

Out loud, lead with the impact, not the activity. The structure:

> **Outcome → who it affects → (optional) what's next.**
...
Neutral is the cure for both. State impact as a **matter of fact**, no edge, no apology, no hype. "Checkout's fixed, it was hitting 4% of users" is unarguable and unembarrassing. You're not performing confidence; you're just reporting reality, and reality happens to be good.
...
The boundary in a status update is **brevity**. You committed to ~60 seconds. Hold it. Don't let a good update sprawl into a five-minute monologue because nobody stopped you. Ending early and clean is a flex; trailing off ("...but yeah, anyway, that's kind of it, I guess") undoes everything.

> 💬 **How to say it:** End on the last fact. "...so that's unblocked now. That's me." Full stop. No trailing apology.
...
- **Listing activity instead of impact.** "I worked on X, Y, Z" is a to-do list, not an update. Lead with what changed.
- **The apology tax.** "I didn't get to as much as I wanted" donates a discount nobody asked for.
- **Overselling thin work.** The room keeps score. Inflated updates get re-rated downward fast.
- **No written trail.** A great verbal update you can't point to in six months didn't happen, as far as promo is concerned.
- **The trailing fade-out.** "...but yeah, anyway" deletes the confidence of everything before it.

See [cues.md](cues.md) for what your manager is actually filing away while you talk.
