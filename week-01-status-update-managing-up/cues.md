...
| ------ | --------------------- |
| You lead with impact, not activity | "Understands the business, not just the ticket." |
| You quantify ("4% of users") | "Thinks in outcomes and numbers, not vibes." |
| You credit a teammate by name | "Secure. Not threatened by sharing the stage." |
| You surface a risk without being asked | "Owns the system, not just their slice." |
| You end clean and on time | "Composed. Respects the room." |
| Your updates connect week to week | "Reliable. Closes loops." |
...
- Taking sole credit for visibly collaborative work.
- Updates that never change ("still working on the same thing") with no narrative of progress.
- Dunking on a teammate or another team to make your work look better.
- Going three minutes over because nobody stopped you.
...
> "Two things: ship alerting on checkout so we don't repeat this, and get the payments project to a demoable state. If the alerting takes longer than I think, I'll push the demo a few days rather than rush it."

Naming the tradeoff *before* they ask is the senior tell.
