# Week 08: Getting credit / handling credit theft
...
1. **Write what you'd say in the moment** (one line) *and* the follow-up message after.
2. **Then open [answer.md](answer.md)** for the credit walkthrough.
3. **Read [cues.md](cues.md)** for the difference between reclaiming credit and looking insecure.
