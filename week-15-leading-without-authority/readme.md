# Week 15: Leading without authority
...
- Zero formal authority; "because I said so" does not exist for you
- Everyone's real boss is somewhere else, with different incentives
- Nagging burns goodwill fast; you need pull, not push
- You're accountable for the outcome but don't control the inputs

**Suggested time budget:** 10 minutes

## ✅ Your job

1. **Write the kickoff message** that gets a cross-functional group aligned and moving.
2. **Then open [answer.md](answer.md)** for the lead-without-authority walkthrough.
3. **Read [cues.md](cues.md)** for what makes people follow someone who can't make them.
