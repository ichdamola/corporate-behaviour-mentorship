...
- Your prior reputation does not transfer automatically
- The new manager has limited time and is forming snap impressions
- Over-eagerness reads as insecure; aloofness reads as disengaged
- You don't yet know their style, priorities, or pet peeves

**Suggested time budget:** 10 minutes to plan the first 1:1

## ✅ Your job

1. **Write your agenda for the first 1:1** and your opening 2–3 sentences.
2. **Then open [answer.md](answer.md)** for the trust-building walkthrough.
3. **Read [cues.md](cues.md)** for what a new manager is deciding about you in week one.
